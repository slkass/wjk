...
window.boot = function () {
  ...
  cc.AssetLibrary.init({
    libraryPath: 'https://cdn.jsdelivr.net/gh/slkass/wjk/res/import',
    rawAssetsBase: 'https://cdn.jsdelivr.net/gh/slkass/wjk/res/raw-',
...
if (false) {
  BK.Script.loadlib('GameRes:https://cdn.jsdelivr.net/gh/slkass/wjk/src/settings.js');
  BK.Script.loadlib();
  ...
  if (isRuntime) {
    require('https://cdn.jsdelivr.net/gh/slkass/wjk/src/settings.js');
    require('https://cdn.jsdelivr.net/gh/slkass/wjk/src/cocos2d-runtime.min.js');
    require('jsb-adapter/engine/index.js');
  } else {
    require('https://cdn.jsdelivr.net/gh/slkass/wjk/src/settings');
    require('https://cdn.jsdelivr.net/gh/slkass/wjk/src/cocos2d-jsb.js');
